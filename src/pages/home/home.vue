    ...
    <div class="top-wrapper">
      ...
      <div class="date">
        <div class="left">
          ...
          <span class="fs12">2020年第14周03.30-04.45</span>
        </div>
        <div class="right">
          <span>&lt;上周</span>
          <span>下周&gt;</span>
    ...
    <div class="content">
      <cube-scroll-nav @change="changeHandler">
        <template slot="bar" slot-scope="props">
          <cube-scroll-nav-bar :labels="props.labels" :txts="props.txts" :current="props.current">
        ...
        <cube-scroll-nav-panel title="" v-for="item in data" :key="item.name" :label="item.name">
          <div class="title" style="margin-top:30px">
            <img src="../../assets/week-title.png" alt="">
            <div class="title-content-wrap">
              <span class="title-content-week">星期一</span>
              <span class="title-content-date"> 2020-04-27</span>
            </div>
          </div>
          <ul>
            <div class="type">
